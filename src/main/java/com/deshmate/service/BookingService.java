...
import com.deskmate.constant.PaymentStatus;
...
public class BookingService {
    ...
    public long createBookingWithPayment(
        ...
        // 1) Validate early
        ValidationUtility.requireNonBlank(deskCode, "deskCode");
        String phone = ValidationUtility.normalizePhone(customerPhone);
