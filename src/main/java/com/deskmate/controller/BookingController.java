...
import com.deshmate.service.BookingService;
import com.deskmate.constant.PaymentMode;
import com.deskmate.utils.DateUtil;
import com.deskmate.utils.InputUtil;
import com.deskmate.utils.Moneyutils;
...
public class BookingController {
    ...
    private void createBooking() {
        ...
        var total = Moneyutils.parse(InputUtil.readString("totalAmount: "));
        ...
        var paid = Moneyutils.parse(InputUtil.readString("paidAmount (must match total): "));
